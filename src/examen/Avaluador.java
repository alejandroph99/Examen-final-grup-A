 ...
 *
 * 1. Tests de tots els mètodes públics i correcció de possible errors (fins a 5
 * punts)
 *
 * 2. 15 ests parametritzats de cada mètode public (3 punts)
 *
 * 3. Tests @Rule de timeout i control d'excepcions de tots els mètodes publics
 * (2 punts)
 *
 */
public class Avaluador {
    ...
    /**
     *
     * Aquest mètode ha de retornar la mitjana de les tres notes parcials d'un
     * estudiant si totes són iguals o superiors a notaSupera.
     *
     * @param estudiant
    ...
    public double mitjanaSiSupera(Estudiant estudiant) throws Exception {
        ...
        if (sumaNotes == 0) {
            throw new Exception("Alguna de las parciales es inferior a 5", new InvalidParameterException());
        }
        return sumaNotes / 3;
    }
    ...
    /**
     *
     * Aquest mètode ha de retornar l'estudiant que té una nota mitjana més alta
     *
     * @param estudiants
